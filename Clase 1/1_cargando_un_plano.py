...
# 6. Configurar la posicion inicial de la camara
distancia = 5.0
yaw = 45.0       # Rotacion horizontal (izq/der)
pitch = -30.0    # Rotacion vertical (arriba/abajo)
objetivo = [0, 0, 0] # Punto al que mira la camara (X, Y, Z)

p.resetDebugVisualizerCamera(distancia, yaw, pitch, objetivo)
while True:
    p.stepSimulation()
